...
Különböző [típusú](/docs/hu/py/types) értékeket rendelhet a változókhoz. A Python dinamikusan tipizált, ami azt jelenti, hogy nem kell explicit módon deklarálni egy változó típusát.
...
Az egyes adattípusok részletes ismertetését lásd a [Python adattípusok](/docs/hu/py/types) útmutatóban.
