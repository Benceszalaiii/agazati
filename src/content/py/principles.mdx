...
Az alábbi példában látható egy `lambda` függvény, amely ellenőrzi, hogy az elem nagyobb-e, mint 5. További információk a lambda függvényekről [itt](/docs/hu/py/functions#lambda-functions) találhatók.
...
Ahhoz, hogy megértsd, hogyan működik a `lambda`, nézd meg [itt](/docs/hu/py/functions#lambda)
