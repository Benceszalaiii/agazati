...
A példa az [f-string](/docs/hu/py/alapok/typusok#f-string) használatát mutatja, amely segítségével a `name` változó értékét helyezzük el egy stringben.
...
Hasonlóképpen, a függvényen kívül definiált változók nem elérhetőek a függvényen belül, hacsak nem adjuk át őket explicit módon argumentumként, vagy deklaráljuk őket [globális változók](/docs/hu/py/alapok/variables#global)ként.
